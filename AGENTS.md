...
| **1** | 10 paying beta users | `tk-nextjs`, `tk-shadcn-ui`, `tk-fastapi`, `adding-auth`, `adding-stripe`, `prod-landing-page`, `mkt-copywriting`, Resend email patterns |
...
- Do not claim Phase 1 complete without auth + Stripe + Resend (roadmap P0)
