...
def build_pipeline_graph():
    ...
    builder.add_node("write_hair_on_fire", node_write_hair_on_fire)
    ...
    builder.add_edge("write_digest", "write_hair_on_fire")
    builder.add_edge("write_hair_on_fire", "send_digest_email")
